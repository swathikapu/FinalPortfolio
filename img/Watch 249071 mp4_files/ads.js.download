...
document.write('<iframe frameborder="0" scrolling="no" width="' + ad_width + '" height="' + ad_height + '" src="' + exoDocumentProtocol + '//syndication.exosrv.com/ads-iframe-display.php?idzone=' + ad_idzone + '&type=' + ad_type + (ad_notify !== "" ? "&notify=" + ad_notify : "") + '&p=' + escape(p) + '&dt=' + dt + '&sub=' + ad_sub + ((ad_sub2 !== "") ? "&sub2=" + ad_sub2 : "") + ((ad_sub3 !== "") ? "&sub3=" + ad_sub3 : "") + '&tags=' + ad_tags + '&screen_resolution=' + ad_screen_resolution + '&el=' + ad_el + '"></iframe>');